...
아이디: <%=userid%><br> 
이름: <%=username%><br>
<form action="UpdateMyInfoServlet" method="post">
	...
	<input type="text" value="<%=email2%>" name="email2" id="email2" placeholder="직접 입력">
	<select id="emailSel">
	...
	<input type="submit" value="정보 수정하기"> <input type="reset" value="취소">
</form>
